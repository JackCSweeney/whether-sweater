...
RSpec.describe ForecastService do
  ...
  describe '.class methods' do
    ...
    describe '.get_forecast_data(coords)' do
      it 'returns a faraday response from the weather api based on the given coordinates' do
        response = @service.get_forecast_data(@coords)
    ...
    describe '.get_forecast(coords)' do
      it 'returns the parsed data from the weather api based on the given coordinates' do
